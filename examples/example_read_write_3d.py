...
def example_read_write_3d(load_filepath, save_filepath):
    # Read 3D image
...
if __name__ == '__main__':
    load_filepath = "examples/data/3d_img.nii.gz"
    save_filepath = "examples/data/3d_img_tmp.nii.gz"

    example_read_write_3d(load_filepath, save_filepath)